...
.swal-button {
  ...
  text-shadow: 0px -1px 0px rgba(0, 0, 0, 0.3);
			...
			<div class="alert alert-default">
				...
				<h1>Integrating Data Subscription API</h1>
				<hr>
				<p>
	
	This section contains the recommended flow for integrating Data Subscription services on the <?php echo $sitetitle; ?> RESTful API.
				</p>
	
	<br>
	<h3 style="color: red;">DATA SUBSCRIPTION  BASE URL</h3>	
	<p><b>Make HTTP POST request to this endpoint</b></p>
	<div class="alert alert-danger"><?php echo $dataurl; ?></div>
	<br>

	<h3 style="color: red;">Required Parameters</h3>
	<p><b>token :</b> This is the generated <b>TOKEN</b> on <?php echo $sitetitle; ?> dashboard.</p>
	<p><b>network :</b> This is the services you are paying for e.g mtn, glo, airtel, etisalat, gifting.</p>
	<p><b>mobile :</b> This is the phone number of the recipient.</p>
	<p><b>plan_code :</b> This is the plan code to identify data vol.</p>
	<p><b>request_id :</b> This is a unique reference generate for each transaction.</p>


<h3 style="color: red;">API Response</h3>
	<p>On a successful data transaction, you get a json response e.g:</p>
	<p style="font-weight: bold;">{code:200, status:success, desc:MTN 2gb purchase successfully on 080312345678}</p>
<br>
<hr>

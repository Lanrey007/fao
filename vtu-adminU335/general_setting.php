...
if (isset($_POST['submit'])){
    ...
    $paystack_sk=$_POST['paystack_sk'];
    $paystack_pk=$_POST['paystack_pk'];
    $vtpass_login=$_POST['vtpass_login'];
                        ...
                        <div class="col-md-12">
                            <form name="sendrequest" id ="sendrequest" method="POST"> 
                                ...
                                <div class="form-group">
                                  <label for="exampleInputEmail1">Flutterwave Secret Key <span style="color:red">*</span></label>
                                    <input type="text" class="form-control" value="<?php echo $paystack_sk; ?>" name="paystack_sk" id="paystack_sk" required autocomplete="off">
                                </div>
                                
                                <div class="form-group ">
                                    <label for="exampleInputEmail1">Flutterwave Public Key <span style="color:red">*</span></label>

...
if (isset($_POST['submit'])){
    ...
    $update=mysqli_query($db, "UPDATE general_setting SET ambassador_price='".$ambassador_price."'");
    if ($update){
                ...
                <form name="sendrequest" id ="sendrequest" method="POST"> 
                   ...
                   <div class="form-group">
                    <label for="exampleInputEmail1">Write Here <span style="color:red">*</span></label>
                       <textarea class="form-control" required="required" name="ambassador_price" id="ambassador_price">

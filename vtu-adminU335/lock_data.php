...
if (isset($_POST['submit'])){
    ...
    $airtelcg=$_POST['airtelcg'];

    $update=mysqli_query($db, "UPDATE locker SET mtn_data='".$mtn."',glo_data='".$glo."',airtel_data='".$airtel."',mobile_data='".$mobile."', gifting_lock='".$gifting."', mobile_data2='".$airtelcg."' WHERE id='1'");
                            ...
                            <form name="sendrequest" id ="sendrequest" method="POST"> 
                               ...
                               <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="airtelcg" class="form-control" name="airtelcg" required="required">
                                        <option selected="" value="">---Select---</option>

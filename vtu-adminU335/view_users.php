...
$get_users = mysqli_query($db, "SELECT * FROM users WHERE reg_active='1' ORDER BY id DESC");
        ...
        <div class="card">
                <div class="card-body">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                      ...
                      <li class="nav-item">
                        <a class="nav-link active" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="true" style="color:blue;">'.$first_name.'-'.$last_name.'</a>
                      </li>

...
if (isset($_POST['submit'])){
  ...
  $rows = mysqli_fetch_array(mysqli_query($db, "SELECT us_wallets,email,emailR FROM users WHERE emailR='".$userid."' OR email='".$userid."'"));
                            ...
                            <form name="sendrequest" id ="sendrequest" method="POST"> 
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="usertype" class="form-control" name="usertype" required="required">
                                      ...
                                      <option value="affliate">Upgrade To Affiliate Account - 1k</option>
                                      
                                      
                                      <option value="topuser">Upgrade To Topuser Account - 3K</option>
                                      
                                       <option value="ambassador">Upgrade To Ambassador Account - 5k</option>
                                      
                                      <option value="earner">Downgrade To Earner Account </option>
